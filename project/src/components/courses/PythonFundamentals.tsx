...
const coursePhases: Phase[] = [
    ...
    topics: [
      {
        ...
        subtopics: [
          ...
          { id: 'syntax', title: 'Python syntax and basic structure', completed: false },
          { id: 'variables', title: 'Variables and data types', completed: false }
        ]
      },
      {
        id: 'data-types',
        ...
        locked: false,
        subtopics: [
          { id: 'numbers', title: 'Numbers (int, float)', completed: false },
          { id: 'strings', title: 'Strings and string operations', completed: false },
          { id: 'lists', title: 'Lists and list methods', completed: false },
          { id: 'dictionaries', title: 'Dictionaries and sets', completed: false }
        ]
      }
    ]
  },
  {
    ...
    description: 'Master control structures and functions in Python',
    icon: '⚡',
    topics: [
      {
        id: 'control-flow',
        ...
        subtopics: [
          ...
          { id: 'loops', title: 'Loops (for, while)', completed: false },
      ...
      },
      {
        ...
        locked: false,
        subtopics: [
          { id: 'function-basics', title: 'Function definition and parameters', completed: false },
          { id: 'return-values', title: 'Return values and scope', completed: false },
          { id: 'lambda', title: 'Lambda functions', completed: false },
          { id: 'decorators', title: 'Function decorators', completed: false }
        ]
      }
    ]
  },
    ...
    topics: [
      {
        ...
        locked: false,
        subtopics: [
          { id: 'class-basics', title: 'Class definition and objects', completed: false },
          { id: 'inheritance', title: 'Inheritance and polymorphism', completed: false },
          { id: 'encapsulation', title: 'Encapsulation and abstraction', completed: false },
          { id: 'magic-methods', title: 'Magic methods', completed: false }
        ]
      }
    ]
  },
  {
    id: 'phase-4',
    title: 'Phase 4: File Handling and Exceptions',
    ...
    topics: [
      {
        ...
        subtopics: [
          ...
          { id: 'read-write', title: 'Reading and writing files', completed: false },
          { id: 'exceptions', title: 'Exception handling', completed: false },
          { id: 'context-managers', title: 'Context managers (with statement)', completed: false }
        ]
      }
    ]
  },
  {
    id: 'phase-5',
    title: 'Phase 5: Modules and Packages',
    description: 'Learn to work with Python modules and packages',
    icon: '📦',
    topics: [
      {
        id: 'modules',
        title: '7. Python Modules',
        description: 'Understanding Python modules and imports',
        completed: false,
        locked: false,
        subtopics: [
          { id: 'import', title: 'Import statements and module creation', completed: false },
          { id: 'packages', title: 'Creating and using packages', completed: false },
          { id: 'virtual-env', title: 'Virtual environments', completed: false },
          { id: 'pip', title: 'Package management with pip', completed: false }
        ]
      }
    ]
  }
