          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center space-x-2 bg-white/5 border border-white/10 rounded-lg py-2.5 px-4 text-white hover:bg-white/10 transition-colors disabled:opacity-70"
              >
