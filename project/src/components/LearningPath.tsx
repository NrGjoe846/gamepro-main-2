...
import ProgrammingQuestionnaire from './questionnaire/ProgrammingQuestionnaire';
  ...
  return (
    <>
      <div className="group relative" onClick={handleClick}>
        ...
        <div className="relative backdrop-blur-md bg-white/10 p-6 rounded-xl border border-white/10 hover:border-white/20 transition-all duration-300 transform hover:scale-[1.02] cursor-pointer">
